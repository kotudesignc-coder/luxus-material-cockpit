...
const FAQ: QA[] = [
  ...
  },
  {
    ...
    a: "可以，而且建議這樣做。客戶最怕「我以為會更淡」的後悔，把 AI 預覽圖用 LINE 傳給客戶看，成交率明顯提高。建議在對話紀錄註明「AI 模擬預覽，實刷會有色差」保護彼此。",
    tag: "designer",
  },
  {
  ...
  {
    q: "你們的色票跟官方的一樣嗎？",
    a: "色號、色名、產品系列都是 LUXUS PAINT 官方提供，由開發商掃描建檔。重要選色仍請以實體色卡為準；建議在與客戶的對話紀錄註明「AI 模擬預覽，實刷會有色差」保護彼此。",
    tag: "designer",
  },
  {
    q: "我可以保留客戶的選色紀錄嗎？",
    a: "目前沒有自動帳號紀錄功能。實務上，把選好的空間預覽圖**下載**或**截圖傳 LINE 給客戶**，這張圖本身就是最完整的「選色紀錄」 — 比起色號文字，圖片更不會看錯。另外，透過各經銷的「業務帳號詢價功能」，可以在紀錄中查找每位客戶的選色歷程。",
    tag: "designer",
  },
];
